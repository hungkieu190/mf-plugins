...
if (!function_exists('lp_lcs_render_license_tab')) {
    /**
     * Render Lesson Completion Sound license tab content
     */
    function lp_lcs_render_license_tab()
    {
        // Get license handler instance
        $plugin = LP_Lesson_Completion_Sound::instance();
        ...
        <h2>LearnPress Lesson Completion Sound - License</h2>
