<?php
/**
 * LearnPress Live Studio License Handler
 * 
 * Handles license activation, validation, and feature gating for LearnPress Live Studio.
 * Based on Mamflow License System but with unique class name to avoid conflicts.
 * 
 * @package MF_LLS_License_Handler
 * @version 1.0.0
 */
...
class MF_LLS_License_Handler
{
    ...
    public function check_license_status()
    {
        ...
        if (is_wp_error($response)) {
            return 'active' === $license_data['status'];
        }
