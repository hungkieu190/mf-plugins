<?php
/**
 * Admin License Settings Page for MF Insights
 * 
 * @package MF_Insights
 */
...
if (!function_exists('mf_insights_render_license_tab')) {
    /**
     * Render MF Insights license tab content
     */
    function mf_insights_render_license_tab()
    {
        $plugin = mf_insights();
        ...
        ?>
        <h2>LearnPress Mamflow Insight - License</h2>
                ...
                <div
                    ...
                    <table class="widefat" style="background: white;">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo esc_html(human_time_diff($license_data['last_check'], current_time('timestamp'))) . ' ago'; ?>
                            </td>
                        </tr>
                    </table>
