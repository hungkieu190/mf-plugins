...
class LP_UPPC_Settings extends LP_Abstract_Settings_Page {
	...
	private function general_settings(): array {
		return [
			...
			[
				'id'       => 'lp_uppc_default_discount_type',
				'title'    => esc_html__( 'Default discount type', 'lp-upsell-progress-coupon' ),
				'type'     => 'select',
				'default'  => 'percent',
				'options'  => [
			...
			[
				'id'       => 'lp_uppc_default_discount_value',
				'title'    => esc_html__( 'Default discount value', 'lp-upsell-progress-coupon' ),
				'type'     => 'number',
				'default'  => 10,
				'css'      => 'width:100px;',
				'custom_attributes' => [
			...
			[
				'id'       => 'lp_uppc_default_expiry_days',
				'title'    => esc_html__( 'Default expiry (days)', 'lp-upsell-progress-coupon' ),
				'type'     => 'number',
				'default'  => 30,
				'css'      => 'width:100px;',
				'custom_attributes' => [
