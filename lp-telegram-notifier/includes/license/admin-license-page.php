 ...
 * 
 * UI for users to enter and manage their license key for LP Telegram Notifier.
 * 
...
if (!function_exists('mf_lp_telegram_render_license_tab')) {
    /**
     * Render LP Telegram Notifier license tab content
     */
    function mf_lp_telegram_render_license_tab()
    {
        // Get license handler instance.
        $plugin = LP_Telegram_Notifier::instance();
        ...
        <h2>
            <?php esc_html_e('LP Telegram Notifier - License', 'lp-telegram-notifier'); ?>
        </h2>
        ...
        <div class="card" style="max-width: 800px;">
            <h2>
                <?php esc_html_e('License Status', 'lp-telegram-notifier'); ?>
            </h2>
            ...
            <?php if ($license_data && $is_active): ?>
                ...
                <div
                    ...
                    <h3 style="margin-top: 0; color: #155724;">✓
                        <?php esc_html_e('License Active', 'lp-telegram-notifier'); ?>
                    </h3>

                    <table class="widefat" style="background: white;">
                        <tr>
                            <td><strong>
                                    <?php esc_html_e('License Key:', 'lp-telegram-notifier'); ?>
                                </strong></td>
                            <td><code><?php echo esc_html($license_data['license_key']); ?></code></td>
                        </tr>
                        <tr>
                            <td><strong>
                                    <?php esc_html_e('Domain:', 'lp-telegram-notifier'); ?>
                                </strong></td>
                            <td>
                        ...
                        <tr>
                            <td><strong>
                                    <?php esc_html_e('Status:', 'lp-telegram-notifier'); ?>
                                </strong></td>
                            <td><span style="color: #155724; font-weight: bold;">
                                    <?php esc_html_e('Active', 'lp-telegram-notifier'); ?>
                                </span></td>
                        </tr>
                        <tr>
                            <td><strong>
                                    <?php esc_html_e('Expiration:', 'lp-telegram-notifier'); ?>
                                </strong></td>
                            <td>
                                <?php
                                if ($license_data['expires_at']):
                                    ...
                                    echo ' <em>' . sprintf(esc_html__('(%d days remaining)', 'lp-telegram-notifier'), $days) . '</em>';
                                else:
                                    echo '<em>' . esc_html__('Lifetime License', 'lp-telegram-notifier') . '</em>';
                                endif;
                                ?>
                            </td>
                        </tr>
                        <tr>
                            <td><strong>
                                    <?php esc_html_e('Last Checked:', 'lp-telegram-notifier'); ?>
                                </strong></td>
                            <td>
                                <?php
                    ...
                    <div style="margin-top: 15px;">
                        <form method="post" style="display: inline-block; margin-right: 10px;">
                            ...
                            <button type="submit" class="button"
                                onclick="return confirm('<?php esc_attr_e('Are you sure you want to deactivate this license?', 'lp-telegram-notifier'); ?>');">
                                <?php esc_html_e('Deactivate License', 'lp-telegram-notifier'); ?>
                            </button>
                        </form>
                        ...
                        <form method="post" style="display: inline-block;">
                            ...
                            <button type="submit" class="button">
                                <?php esc_html_e('Check License Status', 'lp-telegram-notifier'); ?>
                            </button>
                        </form>
                    </div>
                </div>
            ...
            <?php else: ?>
                ...
                <div
                    ...
                    <h3 style="margin-top: 0; color: #856404;">⚠
                        <?php esc_html_e('License Not Activated', 'lp-telegram-notifier'); ?>
                    </h3>
                    <p>
                        <?php esc_html_e('Please enter your license key below to activate premium features.', 'lp-telegram-notifier'); ?>
                    </p>
                </div>
                ...
                <form method="post">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    ...
                                    printf(
                                        ...
                                        esc_html__('Enter the license key you received after purchasing this plugin from %s', 'lp-telegram-notifier'),
                    ...
                    <p class="submit">
                        <button type="submit" class="button button-primary">
                            <?php esc_html_e('Activate License', 'lp-telegram-notifier'); ?>
                        </button>
                    </p>
                </form>
            <?php endif; ?>
            ...
            <h3>
                <?php esc_html_e('Need Help?', 'lp-telegram-notifier'); ?>
            </h3>
            <ul>
                <li><strong>
                        <?php esc_html_e("Where's my license key?", 'lp-telegram-notifier'); ?>
                    </strong>
                    <?php esc_html_e('Check your order confirmation email from mamflow.com', 'lp-telegram-notifier'); ?>
                </li>
                <li><strong>
                        <?php esc_html_e('Lost your key?', 'lp-telegram-notifier'); ?>
                    </strong> <a href="https://mamflow.com/my-account/" target="_blank">
                        <?php esc_html_e('Login to your account', 'lp-telegram-notifier'); ?>
                    </a>
                    <?php esc_html_e('to retrieve it', 'lp-telegram-notifier'); ?>
                </li>
                <li><strong>
                        <?php esc_html_e('Support:', 'lp-telegram-notifier'); ?>
                    </strong>
                    <?php esc_html_e('Contact us at', 'lp-telegram-notifier'); ?> <a
