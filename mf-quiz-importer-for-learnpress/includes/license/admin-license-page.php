<?php
/**
 * Admin License Settings Page for Quiz Importer For LearnPress
 *
...
if (!function_exists('mf_quiz_importer_render_license_tab')) {
    /**
     * Render Quiz Importer For LearnPress license tab content
     */
    function mf_quiz_importer_render_license_tab()
    {
        ...
        ?>
        <h2>
            <?php esc_html_e('Quiz Importer For LearnPress - License', 'mf-quiz-importer-lp'); ?>
        </h2>
        ...
        <div class="card" style="max-width: 800px;">
            <h2>
                <?php esc_html_e('License Status', 'mf-quiz-importer-lp'); ?>
            </h2>
            ...
            <?php if ($license_data && $is_active): ?>
                <div
                    ...
                    <h3 style="margin-top: 0; color: #155724;">✓
                        <?php esc_html_e('License Active', 'mf-quiz-importer-lp'); ?>
                    </h3>

                    <table class="widefat" style="background: white;">
                        <tr>
                            <td><strong>
                                    <?php esc_html_e('License Key:', 'mf-quiz-importer-lp'); ?>
                                </strong></td>
                            <td><code><?php echo esc_html($license_data['license_key']); ?></code></td>
                        </tr>
                        <tr>
                            <td><strong>
                                    <?php esc_html_e('Domain:', 'mf-quiz-importer-lp'); ?>
                                </strong></td>
                            <td>
                        ...
                        <tr>
                            <td><strong>
                                    <?php esc_html_e('Status:', 'mf-quiz-importer-lp'); ?>
                                </strong></td>
                            <td><span style="color: #155724; font-weight: bold;">
                                    <?php esc_html_e('Active', 'mf-quiz-importer-lp'); ?>
                                </span></td>
                        </tr>
                        <tr>
                            <td><strong>
                                    <?php esc_html_e('Expiration:', 'mf-quiz-importer-lp'); ?>
                                </strong></td>
                            <td>
                                <?php
                                if ($license_data['expires_at']):
                                    ...
                                    echo ' <em>' . sprintf(esc_html__('(%d days remaining)', 'mf-quiz-importer-lp'), $days) . '</em>';
                                else:
                                    echo '<em>' . esc_html__('Lifetime License', 'mf-quiz-importer-lp') . '</em>';
                                endif;
                                ?>
                            </td>
                        </tr>
                        <tr>
                            <td><strong>
                                    <?php esc_html_e('Last Checked:', 'mf-quiz-importer-lp'); ?>
                                </strong></td>
                            <td>
                                <?php
                    ...
                    <div style="margin-top: 15px;">
                        <form method="post" style="display: inline-block; margin-right: 10px;">
                            ...
                            <button type="submit" class="button"
                                onclick="return confirm('<?php esc_attr_e('Are you sure you want to deactivate this license?', 'mf-quiz-importer-lp'); ?>');">
                                <?php esc_html_e('Deactivate License', 'mf-quiz-importer-lp'); ?>
                            </button>
                        </form>
                        ...
                        <form method="post" style="display: inline-block;">
                            ...
                            <button type="submit" class="button">
                                <?php esc_html_e('Check License Status', 'mf-quiz-importer-lp'); ?>
                            </button>
                        </form>
                    </div>
                </div>
            ...
            <?php else: ?>
                <div
                    ...
                    <h3 style="margin-top: 0; color: #856404;">⚠
                        <?php esc_html_e('License Not Activated', 'mf-quiz-importer-lp'); ?>
                    </h3>
                    <p>
                        <?php esc_html_e('Please enter your license key below to activate premium features.', 'mf-quiz-importer-lp'); ?>
                    </p>
                </div>
                ...
                <form method="post">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    ...
                                    printf(
                                        ...
                                        esc_html__('Enter the license key you received after purchasing this plugin from %s', 'mf-quiz-importer-lp'),
                    ...
                    <p class="submit">
                        <button type="submit" class="button button-primary">
                            <?php esc_html_e('Activate License', 'mf-quiz-importer-lp'); ?>
                        </button>
                    </p>
                </form>
            <?php endif; ?>
            ...
            <h3>
                <?php esc_html_e('Need Help?', 'mf-quiz-importer-lp'); ?>
            </h3>
            <ul>
                <li>
                    <strong>
                        <?php esc_html_e("Where's my license key?", 'mf-quiz-importer-lp'); ?>
                    </strong>
                    <?php esc_html_e('Check your order confirmation email from mamflow.com', 'mf-quiz-importer-lp'); ?>
                </li>
                <li>
                    <strong>
                        <?php esc_html_e('Lost your key?', 'mf-quiz-importer-lp'); ?>
                    </strong>
                    <a href="https://mamflow.com/my-account/" target="_blank">
                        <?php esc_html_e('Login to your account', 'mf-quiz-importer-lp'); ?>
                    </a>
                    <?php esc_html_e('to retrieve it', 'mf-quiz-importer-lp'); ?>
                </li>
                <li>
                    <strong>
                        <?php esc_html_e('Support:', 'mf-quiz-importer-lp'); ?>
                    </strong>
                    <?php esc_html_e('Contact us at', 'mf-quiz-importer-lp'); ?>
