...
class Example_Licensed_Plugin_Cron {
    ...
    public static function run_license_check() {
        ...
        if (defined('WP_DEBUG') && WP_DEBUG) {
            error_log('Example Licensed Plugin: Daily license check - ' . ($is_valid ? 'VALID' : 'INVALID'));
        }
    ...
    private static function send_admin_notification() {
        ...
        $message = sprintf(
            "Your license for Example Licensed Plugin has failed validation.\n\n" .
            "This could mean:\n" .
            ...
            admin_url('options-general.php?page=example-plugin-license')
        );
...
add_action('init', function() {
    ...
    add_action(Example_Licensed_Plugin_Cron::CRON_HOOK, [Example_Licensed_Plugin_Cron::class, 'run_license_check']);
});
