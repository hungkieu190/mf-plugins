...
function example_licensed_plugin_render_license_page() {
    ...
    $plugin = Example_Licensed_Plugin::get_instance();
    ...
    if (isset($_POST['mamflow_license_action'])) {
        // Verify nonce
        if (!isset($_POST['mamflow_license_nonce']) || 
   ...
   $license_data = $license_handler->get_license_data();
    ...
    ?>
    <div class="wrap">
        <h1>Example Plugin License Settings</h1>
        ...
        <div class="card" style="max-width: 800px;">
                ...
                <div style="padding: 20px; background: #d4edda; border: 1px solid #c3e6cb; border-radius: 4px; margin-bottom: 20px;">
                    ...
                    <table class="widefat" style="background: white;">
                        ...
                        <tr>
                            ...
                            <td><?php echo esc_html(human_time_diff($license_data['last_check'], current_time('timestamp'))) . ' ago'; ?></td>
                        </tr>
                    </table>
            ...
            <ul>
                ...
                <li><strong>Lost your key?</strong> <a href="https://mamflow.com/my-account/" target="_blank">Login to your account</a> to retrieve it</li>
                <li><strong>Support:</strong> Contact us at <a href="mailto:support@mamflow.com">support@mamflow.com</a></li>
            </ul>
        </div>
    </div>
    
    <style>
        .card table.widefat td {
            padding: 10px;
        }
        .card table.widefat tr {
            border-bottom: 1px solid #ddd;
        }
        .card table.widefat tr:last-child {
            border-bottom: none;
        }
    </style>
    <?php
