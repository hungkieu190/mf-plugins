...
// Configuration
const PLUGIN_SLUG = 'lp-sticky-notes';
...
console.log('🚀 Building Sticky Notes Add-on for LearnPress v' + VERSION);
console.log('================================================\n');
...
function copyFiles() {
    ...
    if (fs.existsSync('learnpress-sticky-notes.php')) {
        fs.copyFileSync(
            'learnpress-sticky-notes.php',
            path.join(BUILD_DIR, 'learnpress-sticky-notes.php')
        );
        console.log('  ✓ learnpress-sticky-notes.php');
    }
    
    // Copy directories
    const directories = ['inc', 'assets', 'languages', 'templates'];
...
function generateReleaseInfo() {
    ...
    const info = {
        name: 'Sticky Notes Add-on for LearnPress',
        version: VERSION,
        slug: PLUGIN_SLUG,
