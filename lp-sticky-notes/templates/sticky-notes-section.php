...
<button type="button" class="lp-sticky-notes-toggle" id="lp-sticky-notes-toggle" title="<?php esc_attr_e( 'Toggle Sticky Notes', 'lp-sticky-notes' ); ?>">
	<svg viewBox="-0.5 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" width="20" height="20"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M18.6375 9.04176L13.3875 14.2418C13.3075 14.3218 13.1876 14.3718 13.0676 14.3718H10.1075V11.3118C10.1075 11.1918 10.1575 11.0818 10.2375 11.0018L15.4376 5.84176" stroke="currentColor" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M18.7076 21.6618V21.6618C18.7076 21.9018 18.5176 22.0918 18.2776 22.0918H2.84756C2.60756 22.0918 2.41754 21.9018 2.41754 21.6618V6.23176C2.41754 5.99176 2.60756 5.80176 2.84756 5.80176H12.4875" stroke="currentColor" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M18.3863 2.90824L16.859 4.43558L20.0551 7.63167L21.5824 6.10433L18.3863 2.90824Z" stroke="currentColor" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
</button>
...
<div class="lp-sticky-notes-sidebar" id="lp-sticky-notes-sidebar">
	<div class="lp-sticky-notes-header">
		...
		<button type="button" class="lp-sticky-notes-close" id="lp-sticky-notes-close" title="<?php esc_attr_e( 'Close', 'lp-sticky-notes' ); ?>">
			&times;
		</button>
	</div>
	...
	<div class="lp-sticky-notes-content">
		<div class="lp-sticky-notes-info">
			<p><?php esc_html_e( 'You can add text notes or highlight content and add notes to specific text.', 'lp-sticky-notes' ); ?></p>
			<p class="lp-highlight-instruction">
				<svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2L13.09 8.26L20 9L13.09 9.74L12 16L10.91 9.74L4 9L10.91 8.26L12 2Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
		...
		<div class="lp-sticky-notes-list" id="lp-sticky-notes-list">
			<?php if ( empty( $notes ) ) : ?>
				<div class="lp-no-notes">
					...
					<p><?php esc_html_e( 'No notes yet. Start taking notes to remember important points!', 'lp-sticky-notes' ); ?></p>
				</div>
			<?php else : ?>
				<?php foreach ( $notes as $note ) : ?>
					<div class="lp-note-item" data-note-id="<?php echo esc_attr( $note->id ); ?>" data-note-type="<?php echo esc_attr( $note->note_type ); ?>">
