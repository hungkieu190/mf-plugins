...
class LP_Sticky_Notes_Hooks
{
	...
	public function inject_custom_styles()
	{
		...
		$sidebar_bg_color = LP_Sticky_Notes_Settings::get_setting('lp_sticky_notes_sidebar_bg_color', '#fefce8');
		$note_bg_color = LP_Sticky_Notes_Settings::get_setting('lp_sticky_notes_note_bg_color', '#fff9c4');
		...
		$css_vars = array(
			...
			'--lp-sn-sidebar-bg' => $sidebar_bg_color,
			'--lp-sn-note-bg' => $note_bg_color,
			'--lp-sn-button-bg' => $button_bg_color,
			'--lp-sn-button-text' => $button_text_color,
			'--lp-sn-button-hover-bg' => $button_hover_bg_color,
			'--lp-sn-highlight-bg' => $highlight_bg_color,
			'--lp-sn-highlight-text' => $highlight_text_color,
			'--lp-sn-shortcode-note-bg' => $shortcode_note_bg_color,
			'--lp-sn-shortcode-note-border' => $shortcode_note_border_color,
			'--lp-sn-shortcode-link-color' => $shortcode_link_color,
